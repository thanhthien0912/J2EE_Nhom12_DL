...
const DEFAULT_ORDER_ERROR = 'Đặt hàng thất bại. Vui lòng thử lại.';
    ...
    try {
      ...
      if (paymentMethod === 'MOMO' && orderId) {
        setError(
          getErrorMessage(
            err,
            'Không thể khởi tạo thanh toán MoMo cho đơn hàng vừa tạo. Vui lòng thử lại.',
          ),
        );
      } else {
        setError(getErrorMessage(err, DEFAULT_ORDER_ERROR));
      }
    } finally {
      setLoading(false);
    }
